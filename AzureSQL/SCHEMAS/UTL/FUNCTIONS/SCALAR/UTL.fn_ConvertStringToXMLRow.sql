...
-- ==========================================================================================
CREATE OR ALTER FUNCTION UTL.fn_ConvertStringToXMLRow
(
...
';
   ...
   DECLARE @ustrXMLRootName NVARCHAR(64) = 'Root';
	SELECT  UTL.fn_ConvertStringToXMLRow(@xmlReturnedValue, @ustrXMLRowName, @ustrXMLRootName) AS "XMLValue";
	SELECT  UTL.fn_ConvertStringToXMLRow(@xmlReturnedValue, DEFAULT, DEFAULT) AS "XMLValue with NULL defaults";
